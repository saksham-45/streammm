    ...
    pub fn action_prompt(task: &str, step: u32) -> String {
        format!(
            "You operate a computer from a screenshot like a human at the keyboard and mouse. Task: {task}\nStep: {step}\n\
             ...
             Use right-click, drag (down/move/up), modifier keys, paste, clipboard images, inbox files (including files the person pasted or copied in Finder), and switch displays when a person would.\n\
